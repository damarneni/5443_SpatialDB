<!-- Worked as Team (Dinesh Amarneni and Yaswanth Amaraneni) -->
<!DOCTYPE html>
<html>
  <head>
  ...
  <section>
	...
	<div id="form-stuff">
		...
		<center>
		<table>
    	<td>Lat1: <input type="text" name="lat1" id="lat1"></td>
    	<td>Lon1: <input type="text" name="lon1" id="lon1"></td>
    	<td>Lat2: <input type="text" name="lat2" id="lat2"></td>
    	<td>Lon2: <input type="text" name="lon2" id="lon2"></td>
		</table>
